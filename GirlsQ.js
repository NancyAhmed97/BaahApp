...
const GirlsQ = ({ navigation, route }) => {
  ...
  const totalSteps = route.params?.totalSteps || 19;
  ...
  const SocityScreen = () => {
    return (
      <View style={{ flex: 1, backgroundColor: "white", padding: 30 }}>
        ...
        <View style={styles.educationLevelButtons}>
          <TouchableOpacity
            onPress={() => handleKids('عازبة')}
            style={getKidsStyle('عازبة')}
          >
...
const styles = StyleSheet.create({
  ...
  progressBarContainer: {
    marginBottom: 20,
    paddingTop: 20, // Increase the top padding to push content below the status bar
  },
  inputField: {
    width: "100%",
    height: 50,
